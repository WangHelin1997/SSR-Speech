...
def MyParser():
    ...
    parser.add_argument("--val_every_n_steps", type=int, default=400)
    ...
    # data focused
    parser.add_argument("--pad_x", type=int, default=0, help="whether or not always pad x to have text_max_length. select 1 to get the maximal memory consumption, but the actual case should be smaller, better to have it being 0")
    ...
    parser.add_argument("--n_special", type=int, default=5, help="empty, eog, pad, eos, sos")
    parser.add_argument("--codebook_weight", type=str, default=None, help="e.g. ['5','1','0.5','0.1']")
    parser.add_argument("--max_mask_portion",type=float,default=0.7,help="should mask a utterance for more than this portion, not used")
    ...
    parser.add_argument('--sos', type=int, default=2052, help='start token')
    parser.add_argument('--mts', type=int, default=2053, help='mask token start')
